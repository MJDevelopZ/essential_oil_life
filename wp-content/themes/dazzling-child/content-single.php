...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<footer class="entry-meta">
		...
		<p class="entry-meta"><i class="fa fa-desktop" style="margin-right: 6px;"></i>For more information on how to become a Wellness Advocate or to purchase the oils from this post please visit: <a href="<?php the_field('doterra_shop_link') ?>">My doTerra Shop</a></p>

		<div class="disclaimer">
			<p class="entry-meta"><i class="fa fa-exclamation-circle" style="margin-right: 6px;"></i>I am a doTerra Wellness Advocate and as such receive Bonuses and commissions from the Company. These statements have not been 
				evaluated by the Food and Drug Administration. This product is not intended to diagnose, treat, cure, or prevent disease.</p>
		</div>
